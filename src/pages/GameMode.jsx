        ...
        <div style={{display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(280px, 1fr))', gap:16, marginTop:16}}>
          <div style={{background:'#0e1a2e', border:'1px solid #2b3b55', borderRadius:12, overflow:'hidden', boxShadow:'0 8px 28px rgba(0,0,0,0.35)'}}>
            <div style={{position:'relative'}}>
              <img src={CAMPAIGN_IMG} alt="Campaign key art" style={{width:'100%', height:180, objectFit:'cover', filter:'saturate(0.9)'}} />
          ...
          <div style={{background:'#0e1a2e', border:'1px solid #2b3b55', borderRadius:12, overflow:'hidden', boxShadow:'0 8px 28px rgba(0,0,0,0.35)'}}>
            <div style={{position:'relative'}}>
              <img src={WAVE_IMG} alt="Wave battle key art" style={{width:'100%', height:180, objectFit:'cover'}} />
              <div style={{position:'absolute', inset:0, background:'linear-gradient(180deg, rgba(0,0,0,0) 40%, rgba(0,0,0,0.6) 100%)'}} />
            </div>
            <div style={{padding:'14px 14px 16px'}}>
              ...
              <div style={{display:'flex', gap:8, flexWrap:'wrap', marginTop:8}}>
                ...
                <Link to="/avatar-tuner" className="button" style={{background:'#244b81', borderColor:'#2c5ca0'}}>Tune Avatar</Link>
              </div>
            </div>
          </div>
        </div>
