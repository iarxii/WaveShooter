...
function FlyingDrone({ id, pos, playerPosRef, onDie, isPaused, boundaryJumpActiveRef, assets, trailBaseMat, boundaryLimit = BOUNDARY_LIMIT, speedScale = 1, visualScale=1 }) {
  const ref = useRef()
...
export default React.memo(FlyingDrone)
