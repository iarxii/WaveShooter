...
export const ENEMIES = [
  // Pathogens
  {
    ...
    shape: 'Hexagon', color: 'Red', tier: 1, levelRange: [2, 4],
  ...
  },
  {
    ...
    shape: 'Square', color: 'Orange', tier: 1, levelRange: [4, 7],
  ...
  },
  {
    ...
    shape: 'Pentagon', color: 'Blue', tier: 2, levelRange: [7, 10],
  ...
  },
  {
    ...
    shape: 'Hexagon', color: 'Dark Blue', tier: 3, levelRange: [10, 13],
  ...
  },
  {
    ...
    shape: 'Octagon', color: 'Gray', tier: 2, levelRange: [13, 16],
  ...
  },
  {
    ...
    shape: 'Octagon', color: 'Black', tier: 3, levelRange: [16, 19],
  ...
  },
  {
    ...
    shape: 'Triangle', color: 'Green', tier: 1, levelRange: [19, 22],
    stats: { health: 3, speed: 2.5, damage: 2 }, maxConcurrent: 10,
  ...
  },
  {
    ...
    shape: 'Triangle', color: 'Dark Green', tier: 3, levelRange: [22, 25],
  ...
  },
  {
    ...
    shape: 'Diamond', color: 'Cyan', tier: 2, levelRange: [25, 28],
    stats: { health: 4, speed: 2.2, damage: 3 }, maxConcurrent: 8,
  ...
  },
  {
    ...
    shape: 'Diamond', color: 'Dark Cyan', tier: 3, levelRange: [28, 31],
    stats: { health: 5, speed: 2.0, damage: 4 }, maxConcurrent: 4,
  ...
  },
  {
    ...
    shape: 'Circle', color: 'Pink', tier: 1, levelRange: [31, 34],
  ...
  },
  {
    ...
    shape: 'Circle', color: 'Dark Pink', tier: 2, levelRange: [34, 37],
    stats: { health: 4, speed: 2.3, damage: 3 }, maxConcurrent: 6,
  ...
  },
  {
    ...
    shape: 'Oval', color: 'Purple', tier: 2, levelRange: [37, 40],
  ...
  },
  {
    ...
    shape: 'Circle', color: 'Yellow', tier: 1, levelRange: [40, 43],
  ...
  // Mutagens / Hazards
  {
    ...
    shape: 'Triangle', color: 'Violet', tier: 3, levelRange: [43, 46],
  ...
  },
  {
    ...
    shape: 'Rectangle', color: 'Green', tier: 3, levelRange: [46, 49],
  ...
  },
  {
    ...
    shape: 'Star', color: 'White', tier: 4, levelRange: [49, 52],
  ...
  },
  {
    ...
    shape: 'Crescent', color: 'Brown', tier: 4, levelRange: [52, 55],
  ...
  // Viruses / Major Bosses
  {
    ...
    shape: 'Star', color: 'Cyan', tier: 4, levelRange: [10, 19],
  ...
  },
  {
    ...
    shape: 'Hexagon', color: 'Dark Cyan', tier: 4, levelRange: [20, 29],
  ...
  },
  {
    ...
    shape: 'Circle', color: 'Yellow', tier: 4, levelRange: [30, 39],
  ...
  },
  {
    ...
    shape: 'Triangle', color: 'Dark Green', tier: 4, levelRange: [40, 49],
  ...
  },
  {
    ...
    shape: 'Pentagon', color: 'Pink', tier: 4, levelRange: [50, 59],
    stats: { health: 13, speed: 2.0, damage: 5 }, maxConcurrent: 1,
  ...
  },
  {
    ...
    shape: 'Crescent', color: 'Red', tier: 4, levelRange: [60, 69],
  ...
  },
  {
    ...
    shape: 'Diamond', color: 'Blue', tier: 4, levelRange: [70, 79],
    stats: { health: 12, speed: 2.2, damage: 5 }, maxConcurrent: 1,
  ...
  },
  {
    ...
    shape: 'Oval', color: 'Violet', tier: 4, levelRange: [80, 89],
  ...
  {
    name: 'Housefly', type: 'Vector', scientificName: 'Musca domestica',
    realWorldEffect: 'Mechanical transmission of pathogens; contaminates food and surfaces',
    gameplayEffect: 'Buzz & Drop — flies over players, dropping pathogen hazards',
    shape: 'Model', color: '#A0A0A0', tier: 2, levelRange: [10, 19],
    stats: { health: 5, speed: 2.8, damage: 2 }, maxConcurrent: 5,
    vfx: { onHit: { type: 'bulletHit', color: '#8FE1E9' }, onSpecial: { type: 'pathogenDrop', color: '#8FE1E9' }, onAura: { type: 'buzzField', color: '#8FE1E9', pulse: true } },
    specId: 'housefly_standard'
  },
  {
    name: 'Cockroach', type: 'Vector', scientificName: 'Periplaneta americana',
    realWorldEffect: 'Household pest; linked to allergen/asthma triggers and pathogen carriage',
    gameplayEffect: 'Scuttle & Flee — faster than player, flees when approached; highly resistant to bullets but vulnerable to jumps',
    shape: 'Model', color: '#B36A2E', tier: 2, levelRange: [1, 9],
    stats: { health: 4, speed: 3.8, damage: 1 }, maxConcurrent: 6,
    vfx: { onHit: { type: 'bulletHit', color: '#B36A2E' }, onSpecial: { type: 'fleeBehavior', color: '#B36A2E' }, onAura: { type: 'speedTrail', color: '#8C4F1E' } },
    specId: 'cockroach_flee',
    modelUrl: 'models/enemy/giant-cockroach-fbx/source/giant_cockroach/giant_cockroach.fbx'
  },
