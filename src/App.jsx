...
import { assetUrl, publicAsset, verifyRegisteredAssets } from "./utils/assetPaths.ts";
import { getAccessibility, onAccessibilityChange } from "./utils/accessibility.ts";
import {
  PLAYER_SPEED,
  PLAYER_SPEED_CAP,
  BOUNDARY_LIMIT,
...
import { useDebugControls } from "./hooks/useDebugControls.js";
import { useCameraEffects } from "./hooks/useCameraEffects.js";
...
import useGamepadControls from "./utils/gamepad.js";
...
export default function App({ navVisible, setNavVisible } = {}) {
  ...
  const {
    ...
    disableEnemySpawns, setDisableEnemySpawns, disableEnemySpawnsRef,
    spawnOnlyHazards, setSpawnOnlyHazards, spawnOnlyHazardsRef,
    showAccessibilityControls, setShowAccessibilityControls,
    showEnemyNames, setShowEnemyNames,
    showThumbnails, setShowThumbnails,
    enemyRenderMode, setEnemyRenderMode, enemyRenderModeRef,
  ...
  useEffect(() => {
    const handleCommand = (e) => {
      ...
      if (type === "dash") {
        ...
        if (
          isGameOver ||
          (respawnCountdown && respawnCountdown > 0)
        )
          return;
  ...
  }, [isPaused, isGameOver, respawnCountdown]);
